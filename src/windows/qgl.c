...
BOOL (WINAPI *qwglUseFontOutlines)(HDC, DWORD, DWORD, DWORD, FLOAT, FLOAT, int,
		LPGLYPHMETRICSFLOAT);
		...
		GLint x, GLint y, GLsizei width, GLsizei height, GLint border)
{
	...
	dllCopyTexImage2D(target, level, internalFormat, x, y,
			width, height, border);
}

static void APIENTRY
logCopyTexSubImage1D(GLenum target, GLint level, GLint xoffset, GLint x,
...
static void APIENTRY
logCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
...
static void APIENTRY
logDrawPixels(GLsizei width, GLsizei height, GLenum format, GLenum type,
		const void *pixels)
{
	SIG("glDrawPixels");
...
static void APIENTRY
logFrustum(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top,
...
static void APIENTRY
logGetTexImage(GLenum target, GLint level, GLenum format,
...
static void APIENTRY
logGetTexLevelParameterfv(GLenum target, GLint level, GLenum pname,
		GLfloat *params)
{
...
static void APIENTRY
logGetTexLevelParameteriv(GLenum target, GLint level, GLenum pname,
		GLint *params)
{
...
static void APIENTRY
logMap1d(GLenum target, GLdouble u1, GLdouble u2, GLint stride,
		GLint order, const GLdouble *points)
{
	SIG("glMap1d");
...
static void APIENTRY
logOrtho(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top,
		GLdouble zNear, GLdouble zFar)
{
	SIG("glOrtho");
...
{
	SIG("glTexImage1D");
	dllTexImage1D(target, level, internalformat, width, border,
			format, type, pixels);
}
...
{
	SIG("glTexImage2D");
	dllTexImage2D(target, level, internalformat, width, height,
...
static void APIENTRY
logTexSubImage1D(GLenum target, GLint level, GLint xoffset,
...
{
	SIG("glTexSubImage2D");
	dllTexSubImage2D(target, level, xoffset, yoffset, width, height,
			format, type, pixels);
}
...
QGL_Init(const char *dllname)
{
	...
	qglGetTexLevelParameterfv = dllGetTexLevelParameterfv = GPA(
			"glGetLevelParameterfv");
	qglGetTexLevelParameteriv = dllGetTexLevelParameteriv = GPA(
