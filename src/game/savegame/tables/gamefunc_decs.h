...
extern void G_CheckChaseStats ( const edict_t * ent ) ;
...
extern void player_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void tank_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void supertank_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void parasite_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void mutant_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void mutant_jump_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void medic_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void insane_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void infantry_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void hover_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void gunner_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void gladiator_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void flyer_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void floater_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void flipper_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void chick_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void brain_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void makron_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void makron_torso_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void jorg_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void boss2_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void berserk_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void bfg_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void rocket_touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Grenade_Touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void blaster_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void vectoangles ( const vec3_t value , vec3_t angles ) ;
...
extern edict_t * findradius ( edict_t * from , const vec3_t org , float rad ) ;
...
extern void trigger_push_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Touch_Multi ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void teleporter_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void commander_body_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void barrel_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void func_object_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void point_combat_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void SP_path_corner ( edict_t * self ) ;
extern void path_corner_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void ThrowGib ( edict_t * self , const char * gibname , int damage , gibtype_t type ) ;
extern void gib_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void gib_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void PrecacheItem ( const gitem_t * it ) ;
extern void droptofloor ( edict_t * ent ) ;
extern void Use_Item ( edict_t * ent , edict_t * other , edict_t * activator ) ;
extern edict_t * Drop_Item ( edict_t * ent , const gitem_t * item ) ;
extern void drop_make_touchable ( edict_t * ent ) ;
extern void drop_temp_touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Use_PowerArmor ( edict_t * ent , const gitem_t * item ) ;
extern int PowerArmorType ( const edict_t * ent ) ;
extern qboolean Pickup_Armor ( edict_t * ent , edict_t * other ) ;
extern int ArmorIndex ( const edict_t * ent ) ;
...
extern qboolean Add_Ammo ( edict_t * ent , const gitem_t * item , int count ) ;
extern qboolean Pickup_Key ( edict_t * ent , edict_t * other ) ;
extern void Use_Silencer ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Invulnerability ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Envirosuit ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Breather ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Quad ( edict_t * ent , const gitem_t * item ) ;
...
extern void door_secret_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void door_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void button_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void rotating_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Touch_Plat_Center ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void T_RadiusDamage ( edict_t * inflictor , edict_t * attacker , float damage , const edict_t * ignore , float radius , int mod ) ;
extern void T_Damage ( edict_t * targ , edict_t * inflictor , edict_t * attacker , vec3_t dir , vec3_t point , const vec3_t normal , int damage , int knockback , int dflags , int mod ) ;
...
extern qboolean FacingIdeal ( const edict_t * self ) ;
