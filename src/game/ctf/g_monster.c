...
void
monster_fire_bullet(edict_t *self,
		vec3_t start,
		vec3_t dir,
		int damage,
		int kick,
...
void
monster_fire_shotgun(edict_t *self,
		vec3_t start,
		vec3_t aimdir,
		int damage,
		int kick,
...
void
monster_fire_blaster(edict_t *self,
		vec3_t start,
		vec3_t dir,
		int damage,
		int speed,
...
void
monster_fire_grenade(edict_t *self,
		vec3_t start,
		vec3_t aimdir,
		int damage,
		int speed,
...
void
monster_fire_rocket(edict_t *self,
		vec3_t start,
		vec3_t dir,
		int damage,
		int speed,
...
void
monster_fire_railgun(edict_t *self,
		vec3_t start,
		vec3_t aimdir,
		int damage,
		int kick,
...
monster_start_go(edict_t *self)
{
	...
	if (self->target)
	{
		...
		while ((target =
					G_Find(target, FOFS(targetname), self->target)) != NULL)
		{
