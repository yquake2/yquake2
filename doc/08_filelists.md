...
The game data without binaries / executables. With forward slashes,
Windows has exact the same listing, but with backward slashes. The
three addons *ctf*, *rogue* and *xatrix* are optional.

```
baseq2
baseq2/maps
baseq2/maps.lst
baseq2/maps/testmap.bsp
baseq2/music
baseq2/music/02.ogg
baseq2/music/03.ogg
baseq2/music/04.ogg
